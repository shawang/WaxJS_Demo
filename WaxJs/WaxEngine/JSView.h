...
@property(class, nonatomic, readonly) Class _Nullable layerClass;                        // default is [CALayer class]. Used when creating the underlying layer for the view.
#else
...
@property(nonatomic,readonly,strong)                 CALayer  * _Nullable layer;              // returns view's layer. Will always return a non-nil value. view is layer's delegate
...
@interface JSView : UIView <JSViewExport>
